...
def create_visualization(points, pred_boxes, pred_scores, pred_labels,
    ...
    ax1.set_title(f'BEV Top-Down [CenterPoint]: {sample_id}  |  Dashed=GT  Solid=Pred', fontsize=12, weight='bold')
    ...
    ax2.set_title('3D View [CenterPoint]  |  Dashed=GT  Solid=Pred', fontsize=12, weight='bold')
...
def main():
    parser = argparse.ArgumentParser(description='仓库 CenterPoint 推理可视化')
    parser.add_argument('--cfg_file', type=str,
                        default='cfgs/custom_models/centerpoint_warehouse.yaml')
    parser.add_argument('--ckpt', type=str,
                        default='../output/custom_models/centerpoint_warehouse/default/ckpt/checkpoint_epoch_30.pth')
    parser.add_argument('--root_path', type=str, default='../data/warehouse')
    parser.add_argument('--output_dir', type=str, default='../output/warehouse_centerpoint_inference')
