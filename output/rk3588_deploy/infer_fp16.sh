...
#   bash infer_fp16.sh --single <图路径> [参数] # 单张图, 如 --single imgs/TV_250000012137.jpg --out /root/results
...
#   bash infer_fp16.sh --single imgs/TV_250000012137.jpg --out /root/results
set -e
cd "$(dirname "$0")"
